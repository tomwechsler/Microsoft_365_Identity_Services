...
Get-ADForest | Set-ADForest -UPNSuffixes @{add="tomrocks.xyz"}
...
$LocalUsers | foreach {$newUpn = $_.UserPrincipalName.Replace("tomrocks.local","tomrocks.xyz"); $_ | Set-ADUser -UserPrincipalName $newUpn}
